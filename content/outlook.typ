...
It may be possible to modify edit graphs using quantum identities to create further possibilities for matches and thus reduce the length of resulting edit scripts.
This may improve the predictions of the application scheme.
